...
#sudo mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport fs-0d4c678e.efs.us-east-1.amazonaws.com:/ /opt/mount >> /home/ec2-user/user-data.log
...
yum-config-manager --enable docker-ce-nightly >> /home/ec2-user/user-data.log
echo "################## INSTALLING containerd.io-1.2.6 ######" >> /home/ec2-user/user-data.log
sudo yum -y install https://download.docker.com/linux/centos/7/x86_64/stable/Packages/containerd.io-1.2.6-3.3.el7.x86_64.rpm >> /home/ec2-user/user-data.log
...
sudo docker run -d -p 27017:27107 -v /opt/mount:/data/db mongo
